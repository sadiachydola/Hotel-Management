  ...
  <li><a href="#about">About</a></li>
   ...
   /* Start Update Code */
      if(isset($_REQUEST["btnupdate"]))   /* Update button click event.. */
      {
            ...
            $data = mysqli_query($con,"update room_type set rate='".$_REQUEST["txtprice"]."',type='".$_REQUEST["txtdes"]."',image='".$image."' where room_id='".$_REQUEST["txtid"]."'");
            if($data == TRUE)
            {
          ...
          <input type="hidden" name="txtid" value="<?php echo $row["room_id"]; ?>">
           <center><h1>Update Product Information</h1></center>
            <table align="center" border="0">
                ...
                <tr>
                    <td>Picture:</td>
                    <td><input type="file" name="image"><br/><img src="images/<?php echo $row["image"]; ?>" alt="User Profile" height="100" width="100"></td>
                </tr>
                <tr>
