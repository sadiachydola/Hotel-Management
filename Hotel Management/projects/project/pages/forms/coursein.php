...
<?php
                $connection = mysql_connect('localhost', 'root','db_cse', '') or die("not connected"); //The Blank string is the password
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                 <li><a href="http://127.0.0.1/projects/project/pages/forms/coursein.php"><i class="fa fa-circle-o"></i>Routine Submision</a></li>
				  <li class="active"><a href="http://127.0.0.1/projects/project/pages/tables/1y1s.php"><i class="fa fa-circle-o"></i>Updated Class Routine</a></li>
				 <li><a href="http://127.0.0.1/projects/project/pages/tables/data.html"><i class="fa fa-circle-o"></i>Class Routine</a></li>
              </ul>
            </li>
